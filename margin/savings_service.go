...
// SetStatus represent the product status ("ALL", "SUBSCRIBABLE", "UNSUBSCRIBABLE") - Default: "ALL"
func (s *ListSavingsFlexibleProductsService) SetStatus(status string) *ListSavingsFlexibleProductsService {
	s.status = status
	return s
}

// SetFeatured ("ALL", "TRUE") - Default: "ALL"
func (s *ListSavingsFlexibleProductsService) SetFeatured(featured string) *ListSavingsFlexibleProductsService {
	s.featured = featured
	return s
}

// SetCurrent query page. Default: 1, Min: 1
func (s *ListSavingsFlexibleProductsService) SetCurrent(current int64) *ListSavingsFlexibleProductsService {
	s.current = current
	return s
}

// SetSize Default: 50, Max: 100
func (s *ListSavingsFlexibleProductsService) SetSize(size int64) *ListSavingsFlexibleProductsService {
	s.size = size
	return s
}
...
// SetProductId represent the id of the flexible product to redeem
func (s *RedeemSavingsFlexibleProductService) SetProductId(productId string) *RedeemSavingsFlexibleProductService {
	s.productId = productId
	return s
}

// SetAmount is the quantity of the product to redeem
func (s *RedeemSavingsFlexibleProductService) SetAmount(amount float64) *RedeemSavingsFlexibleProductService {
	s.amount = amount
	return s
}

// SetType ("FAST", "NORMAL")
func (s *RedeemSavingsFlexibleProductService) SetType(redeemType string) *RedeemSavingsFlexibleProductService {
...
// SetAsset desired asset
func (s *ListSavingsFixedAndActivityProductsService) SetAsset(asset string) *ListSavingsFixedAndActivityProductsService {
	s.asset = asset
	return s
}

// SetType set project type ("ACTIVITY", "CUSTOMIZED_FIXED")
func (s *ListSavingsFixedAndActivityProductsService) SetType(projectType string) *ListSavingsFixedAndActivityProductsService {
	s.projectType = projectType
	return s
}

// SetIsSortAsc default "true"
func (s *ListSavingsFixedAndActivityProductsService) SetIsSortAsc(isSortAsc bool) *ListSavingsFixedAndActivityProductsService {
	s.isSortAsc = isSortAsc
	return s
}

// SetStatus ("ALL", "SUBSCRIBABLE", "UNSUBSCRIBABLE") - default "ALL"
func (s *ListSavingsFixedAndActivityProductsService) SetStatus(status string) *ListSavingsFixedAndActivityProductsService {
	s.status = status
	return s
}

// SetSortBy ("START_TIME", "LOT_SIZE", "INTEREST_RATE", "DURATION") - default "START_TIME"
func (s *ListSavingsFixedAndActivityProductsService) SetSortBy(sortBy string) *ListSavingsFixedAndActivityProductsService {
	s.sortBy = sortBy
	return s
}

// SetCurrent Currently querying page. Start from 1. Default:1
func (s *ListSavingsFixedAndActivityProductsService) SetCurrent(current int64) *ListSavingsFixedAndActivityProductsService {
	s.current = current
	return s
}

// SetSize Default:10, Max:100
func (s *ListSavingsFixedAndActivityProductsService) SetSize(size int64) *ListSavingsFixedAndActivityProductsService {
	s.size = size
	return s
}
...
// SetAsset sets the asset parameter.
func (s *SavingFlexibleProductPositionsService) SetAsset(asset string) *SavingFlexibleProductPositionsService {
	s.asset = asset
	return s
}
...
// SetAsset sets the asset parameter.
func (s *SavingFixedProjectPositionsService) SetAsset(asset string) *SavingFixedProjectPositionsService {
	s.asset = asset
	return s
}

// SetStatus ("HOLDING", "REDEEMED"), default will fetch all
func (s *SavingFixedProjectPositionsService) SetStatus(status string) *SavingFixedProjectPositionsService {
	s.status = status
	return s
}

// SetProjectID of the fixed project/activity
func (s *SavingFixedProjectPositionsService) SetProjectID(projectId string) *SavingFixedProjectPositionsService {
