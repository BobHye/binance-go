...
// SetMarginAsset set margin asset
func (s *GetPositionRiskService) SetMarginAsset(marginAsset string) *GetPositionRiskService {
	s.marginAsset = &marginAsset
	return s
}

// SetPair set pair
func (s *GetPositionRiskService) SetPair(pair string) *GetPositionRiskService {
	s.pair = &pair
	return s
}
